...
export const PhysicalHealthDetailRoot = styled.div`
  min-height: 100vh;
...
export const PhysicalHealthDetailBody = styled.div`
  width: 100%;
  max-width: 1600px;
  margin: 0 auto;
  display: flex;
...
export const ProgressFill = styled.div`
  ...
  background-color: ${props => props.$color === 'blue' ? '#2962FF' : 'linear-gradient(90deg, #8E44AD 0%, #A569BD 100%)'};
`;
