...
export function AgencyHealthPage() {
  // 상세 페이지 상태 관리
  const [currentView, setCurrentView] = useState<'main' | 'mental-detail' | 'physical-detail' | 'risk-analysis' | 'survey-list-management' | 'monitoring-detail' | 'unscreened-detail'>('main');
