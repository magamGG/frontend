...
type UserRole = 'artist' | 'manager' | 'agency' | null;
type ArtistSpecialization = 'webtoon-writer' | 'webnovel-writer' | 'assistant-coloring' | 'assistant-lighting' | 'assistant-background' | 'assistant-lineart' | 'assistant-other' | null;
...
const artistSpecializations = [
  {
    value: 'webtoon-writer' as ArtistSpecialization,
    label: '웹툰 작가',
    icon: Pen,
  },
  {
    value: 'webnovel-writer' as ArtistSpecialization,
    label: '웹소설 작가',
    icon: BookOpen,
  },
  {
...
export function SignupPage({ onSignup, onBackToLogin }: SignupPageProps) {
  ...
  const [artistSpecialization, setArtistSpecialization] = useState<ArtistSpecialization>(null);
              ...
              {selectedRole === 'artist' && (
                ...
                >
                  ...
                  <Select 
                    ...
                    onValueChange={(value: ArtistSpecialization) => {
