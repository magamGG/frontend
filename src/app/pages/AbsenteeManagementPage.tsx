...
export function AbsenteeManagementPage() {
  ...
  const [newRequest, setNewRequest] = useState({
    reason: 'break' as 'break' | 'emergency-break' | 'workation' | 'sick-leave',
    startDate: '',
    endDate: '',
    projects: '',
    description: '',
  ...
  const openDetailModal = (request: AbsenceRequest) => {
        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => setNewRequest({ ...newRequest, reason: e.target.value as any })}
