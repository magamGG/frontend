...
const participants = [
  ...
  { name: '박지훈', dept: '디자인팀', status: '완료', statusColor: 'bg-green-50 text-green-700', score, risk: '정상', riskColor: 'bg-green-50 text-green-700', date: '2026.01.17' },
  ...
  { name: '한소희', dept: '재무팀', status: '완료', statusColor: 'bg-green-50 text-green-700', score, risk: '주의', riskColor: 'bg-orange-50 text-orange-700', date: '2026.01.21' },
];
